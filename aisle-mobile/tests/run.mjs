...
const result=spawnSync(process.execPath,['--test',join(out,'agentic.test.mjs'),join(out,'catalogue.test.mjs'),join(out,'pages.test.mjs'),join(out,'history.test.mjs')],{stdio:'inherit',cwd:root});
